...
>(({ className, ...props }, ref) => (
  <AlertDialogPortal>
    ...
    <AlertDialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed left-[50%] top-[50%] z-[10010] grid translate-x-[-50%] translate-y-[-50%] gap-4 border-0 bg-background p-6 shadow-2xl duration-200",
        // Size constraints - never exceed viewport
